        ...
        data = {                                    -- Data that is passed to Javascript
            ...
            wheels = {                              -- Array of wheels to display

                {
                    ...
                    labels = {"imgsrc:hp.png", "imgsrc:inventory.png", "imgsrc:pakaian.png", "imgsrc:animation.png", "imgsrc:document.png", "imgsrc:billing.png", "imgsrc:idcard.png", "imgsrc:mobil.png"},

                    commands = {"gcphonecok", "inventoryhud", "pakaian", "animasi", "dokumen", "billingcok", "idcard", "ruwetcok"}
        ...
        data = {                                    -- Data that is passed to Javascript
            ...
            wheels = {                              -- Array of wheels to display

                {
                    ...
                    commands = {"e no", "e cheer", "e slowclap", "e foldarms2", "e leanwall"}
...

                {
                    ...
                    commands = {"e salute", "e finger", "e peace", "e facepalm", "e damn", "e fail", "e dead", "e gang1", "e gang2", "e copidle", "e holster", "e copcrowd2"}
        ...
        data = {
            ...
            wheels = {

                {
                    ...
                    commands = {"closemenu", "lihatid", "tunjukkanktp", "lihatsim", "tunjukkansim", "lihatlisensi", "tunjukkansenjataku"}
